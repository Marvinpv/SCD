...
int producir_dato(int indice) //OJO! PARECE QUE CADA INDICE DECIDE EL VALOR DE LA VARIABLE CONTADOR
{
   static int contador = 0 + indice*datos_por_productor;
...
// -----------------------------------------------------------------------------
/*
Hay que tener en cuenta que ahora varias hebras esperan en el wait(), si por ejemplo
...
void funcion_hebra_productora( ProdCons1SC * monitor , int indice)
{
